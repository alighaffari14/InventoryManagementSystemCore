...
namespace netcore.Controllers.Invent
{
    ...
    public IActionResult Create(string masterid, string id)
    {
        ...
        var selected = _context.Receiving.SingleOrDefault(m => m.receivingId == masterid);
            ...
            ViewData["receivingId"] = new SelectList(_context.Receiving, "receivingId", "receivingId");
    ...
    public async Task<IActionResult> Create([Bind("receivingLineId,receivingId,branchId,warehouseId,productId,qty,qtyReceive,qtyInventory,createdAt")] ReceivingLine receivingLine)
    {
        if (ModelState.IsValid)
        {
            ...
            await _context.SaveChangesAsync();
                ...
                ViewData["branchId"] = new SelectList(_context.Branch, "branchId", "branchId", receivingLine.branchId);
                ViewData["productId"] = new SelectList(_context.Product, "productId", "productId", receivingLine.productId);
                ViewData["receivingId"] = new SelectList(_context.Receiving, "receivingId", "receivingId", receivingLine.receivingId);
                ViewData["warehouseId"] = new SelectList(_context.Warehouse, "warehouseId", "warehouseId", receivingLine.warehouseId);
        return View(receivingLine);
    }
