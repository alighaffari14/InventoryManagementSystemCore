...
namespace netcore.Controllers.Invent
{
    ...
    public async Task<IActionResult> Create([Bind("warehouseId,warehouseName,description,street1,street2,city,province,country,createdAt")] Warehouse warehouse)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(string id, [Bind("warehouseId,warehouseName,description,street1,street2,city,province,country,createdAt")] Warehouse warehouse)
    {
