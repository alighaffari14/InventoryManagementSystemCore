...
namespace netcore.Controllers
{
    ...
    public async Task<IActionResult> Create([Bind("todoId,todoName,description,HasChild,createdAt")] Todo todo)
    {
...
namespace netcore.MVC
{
  public static partial class Pages
  {
      ...
      {
          public const string Controller = "Todo";
          public const string Action = "Index";
          public const string Role = "Todo";
          public const string Url = "/Todo/Index";
...
namespace netcore.Models
{
  ...
  {
      [Display(Name = "Todo")]
      public bool TodoRole { get; set; } = false;
  }
}
