...
namespace netcore.Controllers
{
    ...
    public class SalesOrderLineController : Controller
    {
        ...
        {
                    var applicationDbContext = _context.SalesOrderLine.Include(s => s.salesOrder);
    ...
    public async Task<IActionResult> Create([Bind("salesOrderLineId,salesOrderLineName,salesOrderId")] SalesOrderLine salesOrderLine)
    {
        if (ModelState.IsValid)
        {
            ...
            await _context.SaveChangesAsync();
                ...
                ViewData["salesOrderId"] = new SelectList(_context.SalesOrder, "salesOrderId", "salesOrderId", salesOrderLine.salesOrderId);
        return View(salesOrderLine);
    }
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(string id, [Bind("salesOrderLineId,salesOrderLineName,salesOrderId")] SalesOrderLine salesOrderLine)
    {
